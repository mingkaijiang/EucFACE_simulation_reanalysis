...
#lot_parameter_trace_within_parameter_space(params= params.aCO2, 
#                                           params.lower = params.aCO2.lower,
#                                           params.upper = params.aCO2.upper,
#                                           inDF = pChain_aCO2_1,
#                                           dist.type=dist.type,
...
## Ring 3
#Chain_aCO2_2 <- MCMC_model_fitting_2(params = params.aCO2, 
#                                     params.lower = params.aCO2.lower,
#                                     params.upper = params.aCO2.upper,
#                                     obs=obsDF[2,],
#                                     chainLength=chainLength,
...
## Ring 6
#Chain_aCO2_3 <- MCMC_model_fitting_2(params = params.aCO2, 
#                                     params.lower = params.aCO2.lower,
#                                     params.upper = params.aCO2.upper,
#                                     obs=obsDF[3,],
#                                     chainLength=chainLength,
...
#Chain.aCO2 <- rbind(pChain_aCO2_1, pChain_aCO2_2, pChain_aCO2_3)

#lot_posterior(inDF = pChain.aCO2, Trt = "aCO2", dist.type = dist.type,
#              chainLength = chainLength)
...
#redict_final_output_2(pChain = pChain.aCO2, 
#                      obs = obsDF[4,],
